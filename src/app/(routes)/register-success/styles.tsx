...
export const StepperItem = styled.div<{ $currentStep: number }>`
  ...
  &:nth-child(2) {
    > div:first-child {
      background-color: ${props => props.$currentStep !== 2 && props.$currentStep !== 3 ? theme.colors.backgroundGrey : theme.colors.tealMain};
      color: ${props => props.$currentStep !== 2 && props.$currentStep !== 3 ? theme.colors.greenMain : theme.colors.backgroundMint};
  ...
  &:nth-child(3) {
    > div:first-child {
      background-color: ${props => props.$currentStep === 3 ? theme.colors.tealMain : theme.colors.backgroundGrey};
      color: ${props => props.$currentStep === 3 ? theme.colors.backgroundMint : theme.colors.greenMain};
